...
export const Services = () => {
  ...
  return (
    <div className='w-full lg:h-screen flex flex-col lg:flex-row font-custom'>
      ...
      <div className='px-4 lg:px-0 py-5 lg:py-0 lg:w-1/2 bg-white lg:h-screen lg:pl-16 flex flex-col items-start justify-center'>
        <p className='text-[40px] font-light'>Services</p>
        <p className='text-[#050505] mt-6 font-custom text-[18px] lg:w-[88%] 2xl:w-[649px] lg:h-fit text-justify tracking-tighter leading-[23.99px]'>
        ...
        <button className='w-[204px] h-[42px] text-black border font-custom border-black hover:bg-white hover:text-black hover:duration-300 mt-6 text-base font-semibold'>
          See More
        </button>
      </div>
    </div>
