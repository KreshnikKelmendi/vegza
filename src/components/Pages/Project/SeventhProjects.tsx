...
const SeventhProjects = () => {
  // Filter projects with IDs 2, 3, and 4
  const filteredProjects = projects.filter(project => [18, 19, 2].includes(project.id));

  return (
    <div className="main_box grid lg:grid-cols-3 py-14 lg:py-0 gap-y-14 lg:gap-y-0 lg:gap-4 bg-black lg:bg-white lg:px-4">
...
export default SeventhProjects;
