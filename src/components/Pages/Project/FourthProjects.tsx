...
const FourthProjects = () => {
  ...
  const filteredProjects = projects.filter(project => [8, 9, 10].includes(project.id));

  return (
    <div className="grid lg:grid-cols-3 lg:py-0 gap-y-14 lg:gap-y-0 lg:gap-4 bg-black lg:bg-white">
