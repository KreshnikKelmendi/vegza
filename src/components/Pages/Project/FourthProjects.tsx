...
const FourthProjects = () => {
  ...
  const filteredProjects = projects.filter(project => [9, 10, 11].includes(project.id));

  return (
    <div className="main_box grid lg:grid-cols-3 lg:py-0 gap-y-14 lg:gap-y-0 lg:gap-4 bg-black lg:bg-white">
