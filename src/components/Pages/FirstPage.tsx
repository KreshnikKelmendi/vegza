    ...
    <div className='relative py-20 lg:py-0 bg-[#0E0E0E]'>
      ...
      <div className='absolute top-0'>
        <div className='flex px-5 flex-col lg:flex-row lg:px-[144px] lg:justify-between 2xl:items-center h-screen'>
          <p className='text-white mt-8 lg:mt-24 2xl:mt-0 text-left text-2xl lg:text-[70px] 2xl:text-[100px] lg:leading-[70px] 2xl:leading-[125.3px] font-thin 2xl:w-[1065px] font-custom '>
          ...
          <div className='flex flex-col lg:justify-center 2xl:justify-start 2xl:mt-0 lg:ml-16'>
            ...
            <p className='text-white text-base mt-6 lg:leading-[21.33px] lg:w-[431px] 2xl:mt-44 text-justify font-thin font-custom'>
            ...
            <button className='w-[204px] h-[42px] font-light text-base font-custom text-white border border-white hover:bg-white hover:text-black hover:duration-300 lg:mt-10 mt-8'>
              See More
            </button>
          </div>
        </div>
