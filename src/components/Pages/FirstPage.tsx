  ...
  return (
    <div className='relative h-screen lg:h-fit lg:py-0 bg-[#0E0E0E]'>
      <video
        ...
        muted
        playsInline
        className='lg:w-3/4 w-fit'
      />

      <div className='absolute top-0'>
        <div className='flex px-5 flex-col lg:flex-row lg:px-[144px] justify-center items-center lg:items-baseline lg:justify-between 2xl:items-center h-screen'>
          ...
          <div className='flex flex-col lg:justify-center 2xl:justify-start 2xl:mt-0 mt-6 lg:ml-16'>
            ...
            <p className='text-white text-sm lg:text-base mt-6 lg:leading-[21.33px] lg:w-[431px] 2xl:mt-44 text-justify font-thin font-custom'>
